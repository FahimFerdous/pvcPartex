window.jwplayer = function (e) {
    ...
    var i, r;
    i = [], r = function () {
        return "7.12.13+commercial_v7-12-13.244.commercial.e03d90.hls.js..jwplayer.bdc5e4.freewheel.98a531.googima.56bbb2.vast.aa7c7d.analytics.785f4d.plugin-gapro.fb7ea6.plugin-related.7adae3.plugin-sharing.586630.vr-plugin.725b2e";
    }.apply(t, i), !(void 0 !== r && (e.exports = r))
}, function (e, t, n) {
    var i, r;
    ...
    r = [n(89), n(96), n(1), n(92), n(93), n(33), n(101), n(53), n(52), n(2), n(81), n(3), n(34), n(5), n(4), n(141), n(95)], o = function (e, t, n, i, r, o, s, u, c, d, f, p, h, g, v, m, y) {
        ...
        return b.prototype = {
            ...
            setup: function (o, m) {
                function w(e, t) {
                    Ee.triggerAfterReady(e, t)
                }

                function b(e, t) {
                    Ee.trigger(v.JWPLAYER_CONTROLS, {
                        controls: t
                    })
                }

                function A() {
                    he = null, fe.on("all", w, Ee);
                ...
                function C() {
                    me.change("visibility", k), me.on("change:controls", b), Ee.trigger(v.JWPLAYER_READY, {
                        setupTime: 0
                    }), Ee.triggerAfterReady = Ee.trigger;
                    for (var e = 0; e < Le.length; e++) {
                        var t = Le[e];
                        ye = t.type === v.JWPLAYER_MEDIA_BEFOREPLAY, Ee.trigger(t.type, t.args), ye = !1
                    }
                ...
                function P() {
                    j(), be = {
                        bail: !1
                    }, me.once("itemReady", _, be)
                }

                function j() {
                    be.bail = !0, me.off("itemReady", _)
                }
                ...
                function x(e, t) {
                    me.get("playOnViewable") && (t ? W() : d.isMobile() && Ee.pause({
                        reason: "autostart"
                    }))
                }
                ...
                function T(e) {
                    ...
                    return t.load(n).then(function () {
                        Ee.getProvider() || (me.setProvider(me.get("playlistItem")), S())
                    })
                }

                function S() {
                    for (; Ee.eventsQueue.length > 0;) {
                        var e = Ee.eventsQueue.shift(),
                            t = e[0],
                            n = e[1] || [];
                        Ee["_" + t].apply(Ee, n)
                    }
                ...
                function I(e, t) {
                    switch (me.get("state") === g.ERROR && me.set("state", g.IDLE), me.set("preInstreamState", "instream-idle"), Ee.trigger("destroyPlugin", {}), J(!0), P(), F(), "undefined" == typeof e ? "undefined" : a(e)) {
                        case "string":
                            M(e);
                            break;
                        case "object":
                ...
                function M(e) {
                    ...
                    t.on(v.JWPLAYER_PLAYLIST_LOADED, function (e) {
                        ...
                        e.message = "Error loading playlist: " + e.message, Ee.triggerError(e)
                    }, Ee), t.load(e)
                }

                function O() {
                    return Ee._instreamAdapter && Ee._instreamAdapter.getState()
                }
                ...
                function N() {
                    ...
                    if (j(), me.set("playReason", e.reason), me.get("state") !== g.ERROR) {
                        ...
                        if (me.get("state") === g.COMPLETE && (J(!0), G(0)), !ye && (ye = !0, Ee.triggerAfterReady(v.JWPLAYER_MEDIA_BEFOREPLAY, {
                        ...
                        i instanceof d.Error && (Ee.triggerError(i), ge = null)
                    }
                }
                ...
                function F() {
                    if (Y(window.event)) {
                        var e = Ee.currentContainer.querySelector("video, audio");
                        e && V() && e.load()
                    }
                }
                ...
                function J(e) {
                    ...
                    return n instanceof d.Error ? (Ee.triggerError(n), !1) : (t && (we = !0), ye && (ve = !0), !0)
                }
                ...
                function B() {
                    ...
                    switch (me.get("state")) {
                        ...
                        case g.BUFFERING:
                            ...
                            if (i instanceof d.Error) return void Ee.triggerError(i);
                            break;
                        default:
                            ye && (ve = !0)
                    }
                ...
                function z(e, t) {
                    me.set("feedData", t);
                    var i = u(e);
                    return i = u.filterPlaylist(i, me, t), me.set("playlist", i), n.isArray(i) && 0 !== i.length ? (T(i), !0) : (Ee.triggerError({
                ...
                function Q() {
                    if (V()) {
                        ...
                        return e === me.get("playlist").length - 1 ? void(me.get("repeat") ? K({
                            reason: "repeat"
                        }) : (d.isIOS() && ce(!1), me.set("playOnViewable", !1), me.set("state", g.COMPLETE), Ee.trigger(v.JWPLAYER_PLAYLIST_COMPLETE, {}))) : void K({
                            reason: "playlist"
                        })
                    }
                }
                ...
                function oe(e) {
                    e = parseInt(e, 10) || 0, me.persistVideoSubtitleTrack(e), Ee.trigger(v.JWPLAYER_CAPTIONS_CHANGED, {
                        tracks: se(),
                        track: e
                    })
                }
                ...
                me.setup(ke, Ce), fe = this._view = new f(m, me), he = new i(m, me, fe, z), he.on(v.JWPLAYER_READY, A, this), he.on(v.JWPLAYER_SETUP_ERROR, this.setupError, this), me.mediaController.on("all", w, this), me.mediaController.on(v.JWPLAYER_MEDIA_COMPLETE, function () {
                    ...
                    Ee.trigger(v.JWPLAYER_CAST_SESSION, t)
                }), me.on("change:fullscreen", function (e, t) {
                    Ee.trigger(v.JWPLAYER_FULLSCREEN, {
                        fullscreen: t
                    }), t && e.set("playOnViewable", !1)
                }), me.on("itemReady", function () {
                    Ee.triggerAfterReady(v.JWPLAYER_PLAYLIST_ITEM, {
                        index: me.get("item"),
                    ...
                    if (t.length) {
                        ...
                        Ee.triggerAfterReady(v.JWPLAYER_PLAYLIST_LOADED, i)
                    }
                }), me.on("change:volume", function (e, t) {
                    Ee.trigger(v.JWPLAYER_MEDIA_VOLUME, {
                        volume: t
                    })
                }), me.on("change:mute", function (e, t) {
                    Ee.trigger(v.JWPLAYER_MEDIA_MUTE, {
                        mute: t
                    })
                }), me.on("change:playbackRate", function (e, t) {
                    Ee.trigger(v.JWPLAYER_PLAYBACK_RATE_CHANGED, {
                        playbackRate: t,
                    ...
                    Ee.triggerAfterReady(v.JWPLAYER_CAPTIONS_LIST, {
                        tracks: t,
                    ...
                    Ee._instreamAdapter && Ee._instreamAdapter.destroy()
    ...
    i = [n(79), n(16), n(1), n(2), n(66), n(100), n(29)], r = function (e, t, i, r, o, a, s) {
        ...
        function u(e, n) {
            var r = n.get("ab");
            r && i.each(r.tests, function (e) {
                i.each(e, function (e) {
                    i.isFunction(e.addConfig) && e.addConfig(n.attributes, e.selection)
                })
            });
            var a = i.clone(n.get("plugins")) || {},
                s = n.get("edition"),
                u = t(s),
            ...
            if (u("ads") && p && (d.test(p.client) ? a[p.client] = p : c.test(p.client) && (a[f + p.client + ".js"] = p), delete p.client), u("jwpsrv")) {
                var h = n.get("analytics");
                i.isObject(h) || (h = {}), l(a, h, "jwpsrv.js")
            }
            l(a, n.get("ga"), "gapro.js"), l(a, n.get("sharing"), "sharing.js");
            var g = n.get("related"),
                v = i.isObject(g),
                m = n.get("controls") !== !1 || v;
            if (m) {
                var y = n.get("visualplaylist") !== !1 || v;
                v || (g = {
                    disableRelated: !0
                }), g.showDockButton = y, l(a, g, "related.js")
            }
            var w = n.get("mobileSdk");
            if (!w) {
                var E = n.get("playlist");
                i.some(E, function (e) {
                    if (e.stereomode && e.stereomode.length > 0) return l(a, n.get("vr") || {}, "vr.js"), !0
                })
            }
            n.set("plugins", a), e()
        }
...
jwplayer.key="btm828LM/pSBP4pRlL2OGhWB67RcArWEmTcjeVKPoSQ=";
...
function numberAnim(postion) {
  ...
  for (var i = 0; i < moduleCard.length; i++) {
    if (animateCard(true, moduleCard[i])) {
      moduleCard[i].classList.add("come-in");
      if (moduleCard[i].getElementsByClassName("startAnim").length != 0 && animFlag && animationFlag[i] && (moduleCard[i].getBoundingClientRect().top < window.innerHeight)) {
        ...
        var valFromHtml = moduleCard[i].getElementsByClassName("jobFigures")[0].innerHTML;
        if (moduleCard[i].getElementsByClassName("jobFigures2")[0])
          var valFromHtml2 = moduleCard[i].getElementsByClassName("jobFigures2")[0].innerHTML;
...
for (var i = 0; i < companyFeedArticle.length; i++) {
  if (companyFeedArticle[i].className == "companyFeedArticle") {
    ...
    if (len >= 420) {
      companyFeedArticle[i].innerHTML = companyFeedArticle[i].innerHTML.substring(0, 420) + "...";
    }
  }
}
...
for (var i = 0; i < ymlArticle.length; i++) {
  if (ymlArticle[i].className == "ymlFeedArticle") {
    ...
    if (len >= 1200) {
      ymlArticle[i].innerHTML = ymlArticle[i].innerHTML.substring(0, 1200) + "...";
    }
  }
}
  ...
  if (fb || twitter || linkedin || mailto) {
    if (fb[i]) {
      ...
      function chngImgColorfb() {
        this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/common/shareOptions/color/FB.svg)";
      }
      fb[i].addEventListener("mouseleave", chngImgfb);

      function chngImgfb() {
        this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/common/shareOptions/FB.svg)";
      }
    }
    if (twitter[i]) {
      ...
      function chngImgColortwitter() {
        this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/common/shareOptions/color/twitter_icon.svg)";
      }
      twitter[i].addEventListener("mouseleave", chngImgtwitter);

      function chngImgtwitter() {
        this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/common/shareOptions/twitter_icon.svg)";
      }
    }
    if (linkedin[i]) {
      ...
      function chngImgColorlinkedin() {
        this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/common/shareOptions/color/LinkedIn.svg)";
      }
      linkedin[i].addEventListener("mouseleave", chngImglinkedin);

      function chngImglinkedin() {
        this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/common/shareOptions/LinkedIn.svg)";
      }
    }
    if (mailto[i]) {
      ...
      function chngImgColormailto() {
        this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/common/shareOptions/color/Contact_Us.svg)";
      }
      mailto[i].addEventListener("mouseleave", chngImgmailto);

      function chngImgmailto() {
        this.style.backgroundImage = "url(/etc/designs/tata/publish/assets/img/common/shareOptions/Contact_Us.svg)";
      }
    }
...
var sheetName = "";
var excelPath = "";
var URL = urlFacts + "excelPath=" + excelPath + "&excelSheet=" + sheetName;
var elemColor;
...
function firstLoad(factsParentIndex, factCard) {
  ...
  URL = urlFacts + "excelPath=" + excelPath + "&excelSheet=" + sheetName;
            ...
            if (!videoDiv.length == 0) {
                ...
                if (window.innerWidth > 991) {
                    ...
                    if (isSafari) {
                        ...
                        jwplayer(videoDiv[0].id).onReady(function () {
                            jwplayer(videoDiv[0].id).on('time', function () {
                                var videoCT = jwplayer(videoDiv[0].id).getPosition();
                                var videoMD = jwplayer(videoDiv[0].id).getDuration();
                                var percent = Math.round((100 * videoCT / videoMD)) + "%";
...
(function () {
    ...
    function scrollEvent(e) {
        ...
        if (nav[0].classList.contains('navSlideDown')) {
            nav[0].classList.remove('navSlideDown');
        } // remove navBar appearance Class
        if (document.getElementsByClassName("parallaxControls").length != 0) {
            parCont();
        }
    ...
    function initParallexE() {
        if (document.getElementsByClassName("parallaxControls").length != 0) {
            if (document.getElementsByClassName("mainSliderElem").length != 0) {
                if (!document.getElementsByClassName("mainSliderElem")[0].classList.contains("parallaxWrapper")) {
        ...
        function changeNavColor(e) {
            ...
            for (var i = elemList.length - 1; i >= 0; i--) {
                ...
                if (elementOffset == elemTop || elemTop == 0) {
                    if (!nav[0].classList.contains("navSlideDown") && !returnScroll) {
                        nav[0].classList.add('navSlideDown'); //navBar appearance
                    }
                ...
                if (!noSliderDiv && elemTop > 50) {
                    nav[0].classList.remove('navSlideDown');
                    if (e.target != null && e.target.activeElement != undefined) {
                        if (e.target.activeElement.getAttribute("isDownload")) {
                            nav[0].classList.add('navSlideDown');
                        }
                    }
                }

                if (elementOffset <= elemTop) {
                    if (elemList[anchorVal].classList.contains("grayNav")) {
                        document.getElementsByClassName('navbar')[0].classList.add('grayMenu');
                        if (nav[0].classList.contains("navBackground")) {
                            nav[0].classList.remove('navBackground');
                    ...
                    if (elemList[anchorVal].classList.contains("customScroll") && modalOpen != false && !nav[0].classList.contains("navBackground")) { // change added
                        nav[0].classList.add('navBackground');
                        nav[0].style.visibility = "visible";
                        ...
                        if ((!elemList[anchorVal].classList.contains("tagsHok") && elemTop > 50 && !returnScroll && window.innerWidth > 992) || (elemTop < 50 && !returnScroll && window.innerWidth > 992)) {
                            if (!elemList[anchorVal].classList.contains("customScroll" && "noSlider")) {
                                nav[0].classList.remove('navBackground');
                                nav[0].style.visibility = "hidden";
                            }
                        } else if (!elemList[anchorVal].classList.contains("customScroll" && "noSlider") && returnScroll && scrolled) {
                            nav[0].classList.remove('navBackground');
                        } else if (window.innerWidth < 992) {
                            if (!nav[0].classList.contains("navBackground") && !nav[0].classList.contains("grayMenu") && elemList[anchorVal].classList.contains("noSliderDiv")) {
                                nav[0].classList.add('navBackground');
                            } else if (!nav[0].classList.contains("navSlideDown") && !nav[0].classList.contains("grayMenu")) {}
                        }
    ...
    function setAnimationF(elem, elemName, elemProp) {
        ...
        if (doughnutDiv && startAni) {
            ...
            if (document.getElementsByClassName("excelPath").length !== 0 && document.getElementsByClassName("excelSheet").length !== 0) {
                ...
                xhrRequest.open('GET', "http://tatadevpublish.westindia.cloudapp.azure.com:4503/bin/companyPieChartDataServlet?excelPath=" + excelPath + "&excelSheet=" + excelSheet, true);
    ...
    function animateElem(e, flagG) {
        if (flagG != undefined)
            ...
            elemDir = e.wheelDelta > 0 || e.detail < 0;
        if (elemDir) {
            ComunityFlagSet = false;
            if (anchorVal > 0) {
...
function searchList(event) {
    ...
    var param = encodeURIComponent(inputValue.replace(/[’’]/g, "'").replace(/[“”]/g, "\"")) + "&start=0&rows=10&wt=json&template=[]";
...
function searchDetails(event, currentPage) {
    ...
    if (isValidated) {
        ...
        if (!showCardsFlag) {
            ...
            if (hashVal) {
                param = "" + encodeURIComponent(localStorage.searchValue.replace(/[‘’]/g, "'").replace(/[“”]/g, "\"")) + "&tags=true&start=" + setCount + "&rows=" + recordRowCount + "&wt=json&template=[" + nodeEl + "]";
            } else {
                param = encodeURIComponent(localStorage.searchValue.replace(/[‘’]/g, "'").replace(/[“”]/g, "\"")) + "&start=" + setCount + "&rows=" + recordRowCount + "&wt=json&template=[" + nodeEl + "]";
            }
        } else {
            if (hashVal)
                param = "" + encodeURIComponent(localStorage.searchValue.replace(/[‘’]/g, "'").replace(/[“”]/g, "\"")) + "&tags=true&start=" + recordStartIndex + "&rows=" + recordRowCount + "&wt=json&template=[" + nodeEl + "]";
            else
                param = encodeURIComponent(localStorage.searchValue.replace(/[‘’]/g, "'").replace(/[“”]/g, "\"")) + "&start=" + recordStartIndex + "&rows=" + recordRowCount + "&wt=json&template=[" + nodeEl + "]";
...
function cardsToHtml(cardsList, cardsToShow) {
    for (var i = cardsToShow.startIndex; i <= cardsToShow.endIndex; i++) {
        ...
        exterImg.setAttribute(
            "src",
            "/etc/designs/tata/publish/assets/img/common/globalSearch/externalLinkIcon.svg"
        );
        ...
        interImg.setAttribute(
            "src",
            "/etc/designs/tata/publish/assets/img/common/globalSearch/arrow_icon_yellow.svg"
        );
        ...
        if (cardsList[i].description.length > 0) {
        ...
        copyImg.setAttribute(
            "src",
            "/etc/designs/tata/publish/assets/img/common/globalSearch/copyIcon.svg"
        );
        ...
        copyImgActive.setAttribute(
            "src",
            "/etc/designs/tata/publish/assets/img/common/globalSearch/copyIconActive.svg"
        );
        ...
        if (cardsList[i].twitterLink.length != 0) {
            ...
            twitterImg.setAttribute(
                "src",
                "/etc/designs/tata/publish/assets/img/common/globalSearch/twitterIcon.svg"
            );
            ...
            twitterImgActive.setAttribute(
                "src",
                "/etc/designs/tata/publish/assets/img/common/globalSearch/twitterIconActive.svg"
            );
        ...
        if (cardsList[i].phoneDetails.length != 0) {
            ...
            phoneImg.setAttribute(
                "src",
                "/etc/designs/tata/publish/assets/img/common/globalSearch/phoneIcon.svg"
            );
            ...
            phoneImgActive.setAttribute(
                "src",
                "/etc/designs/tata/publish/assets/img/common/globalSearch/phoneIconActive.svg"
            );
